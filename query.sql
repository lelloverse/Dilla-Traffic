...
-- Explicitly allow anonymous for local dev if not using Auth yet 
...
-- TEMP DEBUG: Allowing all updates to drivers to test feature
CREATE POLICY "TEMP DEBUG Policy for drivers" ON drivers FOR ALL
USING (true)
WITH CHECK (true);
