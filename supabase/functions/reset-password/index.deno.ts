// Deno-specific Supabase Edge Function
// This file is excluded from main TypeScript compilation
// Deploy separately using: supabase functions deploy reset-password
